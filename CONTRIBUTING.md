...
For a more thorough introduction, [check out WP-CLI's guide to contributing](https://make.wordpress.org/cli/handbook/contributions/contributing/).
...
See [Setting up](https://make.wordpress.org/cli/handbook/contributions/setting-up/) for details on setting up your development environment.
